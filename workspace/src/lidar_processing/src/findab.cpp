...
#include "lidar_processing/pg_info_transfer.h"
const double DETECTION_RANGE = 3.5;
...
*/
            if(!a_b_ready){
                ...
                if (debug){
                    ...
                    {
                        lidar_processing::pg_info_transfer srv;
...
int main(int argc, char **argv){
    ...
    client = nh.serviceClient<lidar_processing::pg_info_transfer>("ab_ident_finished");
